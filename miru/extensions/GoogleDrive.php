...
if (!file_exists('cache')) {
    mkdir('cache', 0777, true);
         ...
         * 
         * Para usar GoogleDrive de GoogleDrive Solo requiere llamar a las siguientes funciones. 
         * 
         * $video_get = 'ID'; // Definimos el ID del video.
         ...
         *  $video_prev = "https://drive.google.com/vt?".$_SERVER["QUERY_STRING"]; // Imagen del video.
         *  
         */
